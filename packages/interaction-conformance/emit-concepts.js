...
function body(opts) {
    ...
    if (opts.notCovered) {
        lines.push(`THE CHECK DOES NOT DECIDE: ${opts.notCovered} Writing code that satisfies the checker is therefore not proof of conformance here — hold the rule, not the regex.`);
    }
    lines.push('', `WHEN WRITING THIS CODE: ${opts.hint}`);
    return lines.join('\n');
}
export function emitConcepts() {
...
//# sourceMappingURL=emit-concepts.js.map