...
export declare const RUN_STATES: readonly ["reached", "not-reached", "running", "waiting", "accepted", "stalled"];
 ...
 * for work that died.
 */
export declare const NON_TERMINAL_STATES: readonly ["running", "waiting", "accepted", "stalled"];
/** Only these two are verdicts. Everything else is a stage. */
export declare const TERMINAL_STATES: readonly ["reached", "not-reached"];
...
export declare const STATE_TOKENS: Readonly<Record<RunState, StateTokens>>;
/**
...
export declare const DEFAULT_CONTENT_FORM: ContentForm;
/**
 ...
 */
export declare const VERDICT_OPTIONS: Readonly<Record<"reached" | "not-reached", readonly string[]>>;
export declare const TOKENS_CSS_PATH = "@avigopal/design-tokens/tokens.css";
export {};
