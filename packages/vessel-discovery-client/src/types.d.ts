 ...
 */
export type AuthTokenSource = "caller_identity" | "user_identity" | "service_identity" | "no_token";
export declare const DEFAULT_AUTH_TOKEN_SOURCE: AuthTokenSource;
/**
...
export declare const DEFAULT_AUTH_DELEGATION_MODE: AuthDelegationMode;
/**
