...
exports.resolveHttpResponseCamel = resolveHttpResponseCamel;
const web_resource_js_1 = require("../resolvers/web-resource.js");
/**
 ...
 */
async function resolveHttpResponseCamel(pointer) {
    ...
    const webResourceResult = await (0, web_resource_js_1.resolveWebResource)({
        type: "web_resource",
        url,
    ...
    if (webResourceResult.shape === "web_resource" && webResourceResult.body && typeof webResourceResult.body === "object" && "ok" in webResourceResult.body && webResourceResult.body.ok) {
        return {
            ...
            body: {
                ...
                body: webResourceResult.body.content || "",
            },
        };
    }
    else {
        ...
        return {
            shape: "httpResponse",
            body: {
                status: webResourceResult.body.status || 500,
                body: webResourceResult.body.error || "Failed to fetch web resource",
            },
        };
    }
}
//# sourceMappingURL=http-response-camel.js.map