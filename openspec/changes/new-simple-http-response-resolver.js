...
exports.simpleHttpResponseResolver = simpleHttpResponseResolver;
const bpl_core_ffi_1 = require("@tool-ai/bpl-core-ffi");
async function simpleHttpResponseResolver(pointer) {
    ...
    try {
        ...
        const statusResponse = await (0, bpl_core_ffi_1.shellResult)({ command: statusCommand });
        ...
        const headersResponse = await (0, bpl_core_ffi_1.shellResult)({ command: headersCommand });
        ...
        const bodyResponse = await (0, bpl_core_ffi_1.shellResult)({ command: bodyCommand });
...
//# sourceMappingURL=new-simple-http-response-resolver.js.map