...
export function buildContract(goal, inferredShapes) {
    ...
    if (NAMES_A_SOURCE_FILE.test(goal)) {
        return {
            ...
            lowSec: 90,
            highSec: 420,
            bandBasis: "a band for code-editing work, taken from the class of run rather than from this goal — no measured history is claimed",
            willAskAbout: [
