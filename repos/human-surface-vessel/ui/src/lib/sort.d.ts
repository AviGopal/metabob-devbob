...
export declare function compareRuns(a: SortableRun, b: SortableRun): number;
export declare function sortRuns<T extends SortableRun>(runs: readonly T[]): readonly T[];
