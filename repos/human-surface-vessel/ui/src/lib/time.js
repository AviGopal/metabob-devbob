 ...
 */
export function parseStartedAt(v, fallback) {
...
export function formatDurationBand(lowSec, highSec) {
    const fmt = (s) => (s < 90 ? `${Math.round(s)} seconds` : `${Math.round(s / 60)} minutes`);
