 ...
 */
export type ExecutionPath = "learned_pathway" | "satisfier" | "universal_tool_fallback" | "feature_compose" | "fresh_derivation";
export declare const EXECUTION_PATH_PROSE: Readonly<Record<ExecutionPath, string>>;
