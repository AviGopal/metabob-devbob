...
async function main() {
    ...
    const auditStarted = events.filter((e) => e.type === "activity.started" && e.data.templateId === "audit-test-report");
    console.log("");
...
//# sourceMappingURL=test-audit-on-report.js.map