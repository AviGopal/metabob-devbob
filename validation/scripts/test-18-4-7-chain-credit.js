...
void (0, _test_audit_loop_1.ensureTestRegistration)({
    ...
    goal_alignment: [{
            ...
            discrimination_claim: "Validates that composition-chain credit propagation writes γ^depth Δα to ancestor variant_performance_metrics — the mechanism by which Thompson Sampling learns over chains, not just leaves.",
        }],
    discrimination_claim: "Discriminates a working chain-credit path from regressions where writeAncestorDelta silently no-ops (the F-V56/F-V57 bug class).",
 ...
 */
async function readAlphaFromMetrics(templateId) {
...
//# sourceMappingURL=test-18-4-7-chain-credit.js.map