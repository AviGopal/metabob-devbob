...
const branch_health_1 = require("../../repos/ias-executor-ts/src/examples/branch-health");
...
async function main() {
    ...
    let vesselReport;
    try {
        const { trace, report } = await (0, branch_health_1.runBranchHealth)(cwd);
    ...
    if (vesselReport.diffStat.filesChanged !== expected.diffStat.filesChanged ||
    ...
    if (vesselReport.recentCommits.length !== expected.recentCommits.length ||
...
//# sourceMappingURL=verify-branch-health.js.map