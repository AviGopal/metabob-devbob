...
describe("Complex numbers", () => {
    ...
    test("Add purely real numbers", () => {
        expect(new ComplexNumber(1, 0).add(new ComplexNumber(2, 0))).toEqual(new ComplexNumber(3, 0));
    });
    test("Add purely imaginary numbers", () => {
        expect(new ComplexNumber(0, 1).add(new ComplexNumber(0, 2))).toEqual(new ComplexNumber(0, 3));
    });
    test("Add numbers with real and imaginary part", () => {
        expect(new ComplexNumber(1, 2).add(new ComplexNumber(3, 4))).toEqual(new ComplexNumber(4, 6));
    });
    test("Subtract purely real numbers", () => {
        expect(new ComplexNumber(1, 0).sub(new ComplexNumber(2, 0))).toEqual(new ComplexNumber(-1, 0));
    });
    test("Subtract purely imaginary numbers", () => {
        expect(new ComplexNumber(0, 1).sub(new ComplexNumber(0, 2))).toEqual(new ComplexNumber(0, -1));
    });
    test("Subtract numbers with real and imaginary part", () => {
        expect(new ComplexNumber(1, 2).sub(new ComplexNumber(3, 4))).toEqual(new ComplexNumber(-2, -2));
    });
    test("Multiply purely real numbers", () => {
        expect(new ComplexNumber(1, 0).mul(new ComplexNumber(2, 0))).toEqual(new ComplexNumber(2, 0));
    });
    test("Multiply imaginary unit", () => {
        expect(new ComplexNumber(0, 1).mul(new ComplexNumber(0, 1))).toEqual(new ComplexNumber(-1, 0));
    });
    test("Multiply purely imaginary numbers", () => {
        expect(new ComplexNumber(0, 1).mul(new ComplexNumber(0, 2))).toEqual(new ComplexNumber(-2, 0));
    });
    test("Multiply numbers with real and imaginary part", () => {
        expect(new ComplexNumber(1, 2).mul(new ComplexNumber(3, 4))).toEqual(new ComplexNumber(-5, 10));
    });
    test("Divide purely real numbers", () => {
        expect(new ComplexNumber(1, 0).div(new ComplexNumber(2, 0))).toEqual(new ComplexNumber(0.5, 0));
    });
    test("Divide purely imaginary numbers", () => {
        expect(new ComplexNumber(0, 1).div(new ComplexNumber(0, 2))).toEqual(new ComplexNumber(0.5, 0));
    });
    test("Divide numbers with real and imaginary part", () => {
        expect(new ComplexNumber(1, 2).div(new ComplexNumber(3, 4))).toEqual(new ComplexNumber(0.44, 0.08));
    });
...
//# sourceMappingURL=complex-numbers.test.js.map