...
let liveSet = null;
try {
    const liveRows = (await q(`SELECT VALUE activity_id FROM activity_execution_traces WHERE executed_at >= time::now() - ${LIVE_WINDOW_HOURS}h AND success = true LIMIT 60000;`))[0]?.result ?? [];
