...
async function main() {
    ...
    let outcome = { at: started, action: "apply_proposal_as_patch" };
    try {
        ...
        outcome = {
            ...
            dispatched: b.dispatched ?? null,
            mitosis_version_id: b.mitosis_version_id ?? null,
...
await main();
//# sourceMappingURL=funnel-drain.js.map